...
init() {
  ...
  if (this.number_of_cells > 2500) { alert('Trop grand ! fais en sorte d avoir moins de 2500 cases'); return false; } // Prevent for big Matrix
  if (this.number_of_cells <= this.number_of_bombs) { alert('ya plus de bombes que de cellules ???'); return false; } // Validation w.r.t number of cells for bombs
