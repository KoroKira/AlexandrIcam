...
Game.prototype.init = function () {
  ...
  if (this.number_of_cells > 2500) { alert('C est trop grand, change à - de 2500 cases stp'); return false }
  if (this.number_of_cells <= this.number_of_bombs) { alert('plus de bombes que de case ? pas possible'); return false }
  var that = this
  this.moveIt(true)
  this.map.innerHTML = ''
